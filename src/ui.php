...
function ui_icon(string $name, string $class = 'icon'): string
{
    $paths = [
        ...
        'diagnostic' => '<path d="M9 3h6l1 2h3a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7a2 2 0 0 1 2-2h3l1-2Z"/><path d="M9 12l2 2 4-4M8 18h8"/>',
        'corrections' => '<path d="M4 20h4l10-10-4-4L4 16v4Z"/><path d="m12.5 7.5 4 4M14 20h6"/>',
        'review' => '<path d="M20 11a8 8 0 1 0 2 5"/><path d="M20 4v7h-7"/><path d="m9 12 2 2 4-4"/>',
        'history' => '<path d="M3 12a9 9 0 1 0 3-6.7L3 8"/><path d="M3 3v5h5M12 7v5l3 2"/>',
        'streak' => '<path d="M12 22c4 0 7-3 7-7 0-5-4-7-3-12-4 2-7 6-7 10-2-1-3-3-3-5-2 2-3 5-3 7 0 4 3 7 6 7Z"/><path d="M12 22c2 0 4-2 4-4 0-2-1-4-4-6-3 2-4 4-4 6 0 2 2 4 4 4Z"/>',
        'achievement' => '<circle cx="12" cy="8" r="5"/><path d="m8.5 12-1.5 9 5-3 5 3-1.5-9"/><path d="m12 5 1 2 2 .3-1.5 1.5.4 2.2-1.9-1-1.9 1 .4-2.2L9 7.3 11 7l1-2Z"/>',
    ];
