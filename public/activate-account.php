...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        access_activate_account($record, $password, $email !== '' ? $email : null);
...
<div class="login-page login-page-redesign">
    <section class="login-visual" aria-label="Ativação do portal RS English">
        ...
        <div class="login-brand">
            ...
            <h1 class="login-hero-title">Crie sua senha e acompanhe <span>toda a sua evolução.</span></h1>
    ...
    <section class="login-form-side">
        <div class="login-box">
            ...
            <?php if ($activated): ?>
                ...
                <p class="login-form-intro">Sua senha foi criada e seu acesso já está conectado ao histórico da Emma.</p>
            ...
            <?php else: ?>
                ...
                <p class="login-form-intro">Crie sua senha. Depois, você poderá entrar usando seu telefone <strong><?= e((string)$record['phone']) ?></strong>.</p>
                ...
                <form method="post" novalidate>
                    ...
                    <div class="form-row login-field">
                        ...
                        <input id="email" type="email" name="email" autocomplete="email" value="<?= e((string)($record['email'] ?? '')) ?>" placeholder="voce@exemplo.com">
                    </div>
                    <div class="form-row login-field">
