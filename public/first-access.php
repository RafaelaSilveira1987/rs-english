...
<div class="login-page">
    <div class="login-box">
        ...
        <p>Seu usuário é criado automaticamente a partir do cadastro usado pela Emma no WhatsApp.</p>
        <div class="list-card">
            <strong>Como receber o link</strong>
            <p>Envie a palavra <strong>ACESSO</strong> para a Emma no mesmo WhatsApp em que você estuda. Ela enviará um novo link seguro para criar sua senha.</p>
        </div>
